  ...
  return (
    ...
    <h3>Run New Plan</h3>
      <ButtonGroup>
        ...
        <ActionButton onClick={() => setShowOffcanvas(true)}>Upload</ActionButton> {/* Show offcanvas on click */}
      </ButtonGroup>
    ...
    <SubmitButton id={"button"}  onClick={() => console.log('Submit clicked!')} disabled={isDisabled}>Submit & Run Plan</SubmitButton>
